...
- ao clicar em **↻**, atualiza os dados e consulta a versão mais recente no GitHub; se houver versão nova, baixa o ZIP para instalação manual (ou abre Releases se o arquivo não estiver disponível).
