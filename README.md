...
1. Baixe e extraia `baiak-jarvis-chrome-v0.4.2.zip` na página de Releases.
...
1. Baixe e extraia `baiak-jarvis-firefox-v0.4.2.zip` na página de Releases.
...
O rodapé do painel deve mostrar `Jarvis 0.4.2 AUTO · execução local`.
